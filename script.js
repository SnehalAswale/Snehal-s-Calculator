...
//calculate square root of the number currently on screen
...
//calculate the division of 1 with the number currently on screen
...
//calculate the power of the number currently on screen
function power_of() {
    box = document.getElementById("box");
...
//clear last number typed into the display
